...
namespace tree_search {
        ...
        struct preorder_search {
            ...
            void step() {
                ...
                do {
                    ...
                    if (last.ptr_->right_ && last.ptr_->value_.first <= this->interval_.second) this->s_.emplace(cont{ last.ptr_->right_.get() });
                    if (last.ptr_->left_ && last.ptr_->left_->augment_.max_ >= this->interval_.first) this->s_.emplace(cont{ last.ptr_->left_.get() });

                    if (this->interval_.first <= last.ptr_->value_.second && this->interval_.second >= last.ptr_->value_.first) {
                        last.visited_ = true;
                        this->s_.emplace(last);
                    }
                } while (!this->s_.empty() && !this->s_.top().visited_);
            }
            std::stack<cont> s_ = {};
            typename Node::value_type interval_ = {};
        };
    ...
    struct search_iterator_interval
        ...
        bool operator==(const search_iterator_interval& other) const {
            return this->s_ == other.s_ && this->interval_ == other.interval_;
        }
        bool operator!=(const search_iterator_interval& other) const {
            return !(*this == other);
        }
